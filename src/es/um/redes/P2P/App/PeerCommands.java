...
public class PeerCommands {
	...
	public static final byte COM_CONFIG = 1; //Pedir tamaño chunk
	public static final byte COM_ADDSEED = 2;
	public static final byte COM_QUERY = 3;
	public static final byte COM_DOWNLOAD = 4; //antes hay que preguntarpor  seeds
	public static final byte COM_QUIT = 5; //hay que dar de baja antes lo ficheros (remove_seed)
	public static final byte COM_SHOW = 6; //imprime ficheros de la carpeta
	public static final byte COM_HELP = 7;
	public static final byte COM_GET_SEEDS = 8; //nuevo
	//public static final byte COM_REMOVE_SEED = 9; //nuevo
